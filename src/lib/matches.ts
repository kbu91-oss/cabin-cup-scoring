...
const SCHEDULED: Record<DrinkingEventId, { harvey: string; carbery: string; slot: number }[]> = {
  'beer-die': [
    ...
    { harvey: 'Meyers & Tiefenwerth',     carbery: 'Luczyk & Hilbrich',     slot: 2 },
  ...
  'beer-pong': [
    ...
    { harvey: 'Bouharevich & Arnt',         carbery: 'Sanner & Hilbrich',     slot: 2 },
    { harvey: 'Hibbeler & Meyers',          carbery: 'Bui & Luczyk',           slot: 2 },
    { harvey: 'Tiefenwerth & Meyers',       carbery: 'Bui & Soren',           slot: 3 },

...
const SCHEDULED: Record<DrinkingEventId, { harvey: string; carbery: string; slot: number }[]> = {
  'beer-die': [
    ...
    { harvey: 'Arnt & Hibbeler',          carbery: 'Looch & Sanner',        slot: 1 },
    { harvey: 'Meyers & Tiefenwerth',     carbery: 'Robinson & Hilbrich',   slot: 2 },
    { harvey: 'Ghost & Harvey',           carbery: 'Soren & Carbery',       slot: 2 },
    { harvey: 'Bouharevich & Arnt',       carbery: 'Bui & Looch',           slot: 3 },
    { harvey: 'Hibbeler & Meyers',        carbery: 'Sanner & Robinson',     slot: 3 },
    { harvey: 'Tiefenwerth & Ghost',      carbery: 'Hilbrich & Soren',      slot: 4 },
    { harvey: 'Harvey & Arnt',            carbery: 'Carbery & Looch',       slot: 4 },
    { harvey: 'Bouharevich & Hibbeler',   carbery: 'Bui & Sanner',          slot: 5 },
    { harvey: 'Meyers & Ghost',           carbery: 'Robinson & Soren',      slot: 5 },
    { harvey: 'Tiefenwerth & Harvey',     carbery: 'Hilbrich & Carbery',    slot: 6 },
    { harvey: 'Arnt & Meyers',            carbery: 'Looch & Robinson',      slot: 6 },
    { harvey: 'Hibbeler & Tiefenwerth',   carbery: 'Sanner & Hilbrich',     slot: 7 },
    { harvey: 'Bouharevich & Ghost',      carbery: 'Bui & Soren',           slot: 7 },
  ],
  'bags': [
    ...
    { harvey: 'Arnt & Ghost',               carbery: 'Looch & Soren',         slot: 3 },
    { harvey: 'Bouharevich & Hibbeler',     carbery: 'Robinson & Hilbrich',   slot: 3 },
    { harvey: 'Hibbeler & Ghost',           carbery: 'Sanner & Soren',        slot: 4 },
    { harvey: 'Arnt & Tiefenwerth',         carbery: 'Looch & Hilbrich',      slot: 4 },
    { harvey: 'Harvey & Arnt',              carbery: 'Bui & Sanner',          slot: 5 },
    { harvey: 'Meyers & Tiefenwerth',       carbery: 'Carbery & Looch',       slot: 5 },
    { harvey: 'Harvey & Ghost',             carbery: 'Looch & Robinson',      slot: 6 },
    { harvey: 'Arnt & Meyers',              carbery: 'Carbery & Soren',       slot: 6 },
    { harvey: 'Bouharevich & Ghost',        carbery: 'Sanner & Hilbrich',     slot: 7 },
    { harvey: 'Hibbeler & Tiefenwerth',     carbery: 'Bui & Soren',           slot: 7 },
  ],
  'beer-pong': [
    { harvey: 'Harvey & Bouharevich',       carbery: 'Looch & Sanner',        slot: 1 },
    { harvey: 'Arnt & Hibbeler',            carbery: 'Carbery & Bui',         slot: 1 },
    { harvey: 'Bouharevich & Arnt',         carbery: 'Sanner & Robinson',     slot: 2 },
    { harvey: 'Hibbeler & Meyers',          carbery: 'Bui & Looch',           slot: 2 },
    { harvey: 'Tiefenwerth & Ghost',        carbery: 'Robinson & Soren',      slot: 3 },
    { harvey: 'Harvey & Hibbeler',          carbery: 'Hilbrich & Carbery',    slot: 3 },
    { harvey: 'Meyers & Ghost',             carbery: 'Hilbrich & Soren',      slot: 4 },
    { harvey: 'Tiefenwerth & Harvey',       carbery: 'Carbery & Sanner',      slot: 4 },
    { harvey: 'Harvey & Meyers',            carbery: 'Bui & Robinson',        slot: 5 },
    { harvey: 'Bouharevich & Tiefenwerth',  carbery: 'Looch & Soren',         slot: 5 },
    { harvey: 'Bouharevich & Meyers',       carbery: 'Carbery & Robinson',    slot: 6 },
    { harvey: 'Arnt & Ghost',               carbery: 'Bui & Hilbrich',        slot: 6 },
    { harvey: 'Hibbeler & Ghost',           carbery: 'Looch & Hilbrich',      slot: 7 },
